...
const Story = () => {
  ...
  return (
    ...
    >
      ...
      <div
          className={`${
            isEducation ? "education-box" : "experience-box"
          } ${fade ? "fadeIn" : ""} story-box text-left p-5 flex flex-col sm:items-center`}
        >
          {(isEducation ? education : experience).map((ed, index) => {
            return (
              <div
                key={index}
