export default function SocialLine() {
  return (
    <div className="hidden lg:block fixed social-line fadeInBottom top-[70%] left-[5%] text-color-light">
      <div className="flex flex-col justify-center items-center gap-4 mb-3">
        <a href="https://github.com/mirkodeglinnocenti" target="blank">
          <svg
            ...
            fill="white"
            stroke="white"
            className="w-8 hover:fill-primary-color hover:scale-125 transition-transform duration-500"
          >
